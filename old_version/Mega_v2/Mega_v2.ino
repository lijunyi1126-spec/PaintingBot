...
void Draw() {
  ...
  moveSafe(x_brush_2+50, y_brush_1,z_floor-80+40);
  moveSafe(x_brush_2+50, y_brush_1,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_floor-k-60+40);
  moveSafe(x_brush_2+50, y_brush_2, z_floor-40+40);
  moveSafe(x_brush_2+50, y_brush_2, z_mid);
  moveSafe(x_brush_1, y_brush_3,z_mid);
  moveSafe(x_brush_1, y_brush_3,z_floor-k-60+60);
  moveSafe(x_brush_2+50, y_brush_3,z_floor-40+60);
...
void DrawCounter() {
  ...
  // moveSafe(x_brush_2, y_brush_3,z_floor-k-60+60+40);
  // moveSafe(x_brush_1+50, y_brush_3,z_floor-40+60+40);
  // moveSafe(x_brush_1+50, y_brush_3,z_mid);
  // moveSafe(x_brush_2, y_brush_2,z_mid);
  // moveSafe(x_brush_2, y_brush_2,z_floor-k-60+40+40);
  // moveSafe(x_brush_1+50, y_brush_2, z_floor-40+40);
  // moveSafe(x_brush_1+50, y_brush_2, z_mid);
  // moveSafe(x_brush_2, y_brush_1,z_mid);
  // moveSafe(x_brush_2, y_brush_1,z_floor-k-60+40+40);
  // moveSafe(x_brush_1+50, y_brush_1,z_floor-40+40+40);
  // moveSafe(x_brush_1+50, y_brush_1, 0);

  moveSafe(x_brush_2, y_brush_3,z_floor-k-60+60+40-20);
  moveSafe(x_brush_1, y_brush_3,z_floor-40+60+40);
  moveSafe(x_brush_1, y_brush_3,z_mid);
  moveSafe(x_brush_2-50, y_brush_2,z_mid);
  moveSafe(x_brush_2-50, y_brush_2,z_floor-k-60+40+40);
  moveSafe(x_brush_1, y_brush_3, z_floor-40+40);
  moveSafe(x_brush_1, y_brush_3, z_mid);
  moveSafe(x_brush_2-50, y_brush_1,z_mid);
  moveSafe(x_brush_2-50, y_brush_1,z_floor-k-60+40+40);
  moveSafe(x_brush_1, y_brush_2,z_floor-40+40+40);
  moveSafe(x_brush_1, y_brush_2, 0);
}
void Draw2() {
  int k = 100; int a = 25; int b = 50;
  moveXY(x_brush_1, y_brush_1+a);
  moveSafe(x_brush_1, y_brush_1+a,z_floor-k-60+40+20+60-20);
  moveSafe(x_brush_2+50, y_brush_1+a+b,z_floor-80+40+40+20+60-20);
  moveSafe(x_brush_2+50, y_brush_1+a+b,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_floor-k-60+40+40+20+60-20);
  moveSafe(x_brush_2+50, y_brush_2+b, z_floor-40+40+40+60+20-20);
  moveSafe(x_brush_2+50, y_brush_2+b, z_mid);
  moveSafe(x_brush_1, y_brush_3-a,z_mid);
  moveSafe(x_brush_1, y_brush_3-a,z_floor-k-60+40+40+20+60-20);
  moveSafe(x_brush_2+50, y_brush_3-a+b,z_floor-40+40+40+20+60-20);
...
void Draw3() {
  ...
  moveSafe(x_brush_1, y_brush_3+a+b,z_floor-k-60+40+80);
  moveSafe(x_brush_2+50, y_brush_3+a+b-c,z_floor-80+40+40+80);
  moveSafe(x_brush_2+50, y_brush_3+a+b-c,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_floor-k-60+40+40+80);
  moveSafe(x_brush_2+50, y_brush_2-c, z_floor-40+40+40+80);
  moveSafe(x_brush_2+50, y_brush_2-c, z_mid);
  moveSafe(x_brush_1, y_brush_1-a-b,z_mid);
  moveSafe(x_brush_1, y_brush_1-a-b,z_floor-k-60+40+40+80);
  moveSafe(x_brush_2+50, y_brush_1-a-b-c,z_floor-40+40+40+80);
