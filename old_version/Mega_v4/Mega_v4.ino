...
void Draw() {
  ...
  moveSafe(x_brush_1, y_brush_1,z_floor-k-60-50);
  moveSafe(x_brush_2+50, y_brush_1,z_floor-80-50);
  moveSafe(x_brush_2+50, y_brush_1,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_floor-k-60+40-10-50);
  moveSafe(x_brush_2+50, y_brush_2, z_floor-40+40-10-50);
  moveSafe(x_brush_2+50, y_brush_2, z_mid);
  moveSafe(x_brush_1, y_brush_3,z_mid);
  moveSafe(x_brush_1, y_brush_3,z_floor-k-60+60+20-20-50);
  moveSafe(x_brush_2+50, y_brush_3,z_floor-40+60+20-20-50);
...
void Draw2() {
  ...
  moveSafe(x_brush_1, y_brush_1+a,z_floor-k-60+40+20+60-20-20);
  moveSafe(x_brush_2+50, y_brush_1+a+b,z_floor-80+40+40+20+60-20-20);
  moveSafe(x_brush_2+50, y_brush_1+a+b,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_floor-k-60+40+40+20+60-20-20);
  moveSafe(x_brush_2+50, y_brush_2+b, z_floor-40+40+40+60+20-20-20);
  moveSafe(x_brush_2+50, y_brush_2+b, z_mid);
  moveSafe(x_brush_1, y_brush_3-a,z_mid);
  moveSafe(x_brush_1, y_brush_3-a,z_floor-k-60+40+40+20+60-20-20);
  moveSafe(x_brush_2+50, y_brush_3-a+b,z_floor-40+40+40+20+60-20-20);
...
void Draw3() {
  ...
  moveSafe(x_brush_1, y_brush_3+a+b,z_floor-k-60+40+80-40);
  moveSafe(x_brush_2+50, y_brush_3+a+b-c,z_floor-80+40+40+80-40);
  moveSafe(x_brush_2+50, y_brush_3+a+b-c,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_mid);
  moveSafe(x_brush_1, y_brush_2,z_floor-k-60+40+40+80-40);
  moveSafe(x_brush_2+50, y_brush_2-c, z_floor-40+40+40+80-40);
  moveSafe(x_brush_2+50, y_brush_2-c, z_mid);
  moveSafe(x_brush_1, y_brush_1-a-b,z_mid);
  moveSafe(x_brush_1, y_brush_1-a-b,z_floor-k-60+40+40+80-40);
  moveSafe(x_brush_2+50, y_brush_1-a-b-c,z_floor-40+40+40+80-40);
